...
$i18n_installer = array (
	...
	"0038"	=>	"Modalità di autenticazione",
	...
	"0041"	=>	"Indirizzo dell'RPC esterno",
	"0042"	=>	"Abilita una chiave condivisa per l'RPC esterno",
	"0043"	=>	"Chiave condivisa dell'RPC esterno",
	"0044"	=>	"Impostazioni di autenticazione ldap/dominio",
	"0045"	=>	"Indirizzo del server ldap",
	"0046"	=>	"Porta su cui è in ascolto il server ldap",
	"0047"	=>	"dc(s) separati da virgola (ex. \"dc=company, dc=net\" per @company.net)",
	"0048"	=>	"Altri DN (ex. \"cn=users\")",
	"0049"	=>	"Utente che può effettuare il listing dell'alberatura (lascia vuoto se ogni utente può farlo)",
	"0050"	=>	"Password dell'utente che può listare l'alberatura",
	"0051"	=>	"Usa modalità compatibile (seleziona se hai incontrato problemi, per esempio con Active Directory)",
	...
	"0098"	=>	"Trasporto per l'RPC externo",
	...
	"0135"	=>	"Cartella home",
	"0136"	=>	"Porta del server RPC remoto",
