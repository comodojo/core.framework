...
class simplelogin extends application {
	
	public function init() {
		$this->add_application_method('getInfo', 'getUserInfo', Array(), 'returns logged in user basic information; no extra parameter is required',false);
	}
