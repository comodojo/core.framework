...
$i18n_installer = array (
	...
	"0038"	=>	"Authentication mode",
	"0039"	=>	"Self registration mode",
	"0040"	=>	"Enable cache for external authentications (ldap/external authenticator)",
	"0041"	=>	"External RPC address",
	"0042"	=>	"Enable shared key security for external RPC",
	"0043"	=>	"External RPC shared key",
	"0044"	=>	"Ldap/domain authentication settings",
	"0045"	=>	"Ldap server address",
	"0046"	=>	"Ldap port",
	"0047"	=>	"dc(s) comma separated (i.e. \"dc=company, dc=net\" for @company.net)",
	"0048"	=>	"Other DN (i.e. \"cn=users\")",
	"0049"	=>	"Username that can list ldap tree (leave blank if every user can do that)",
	"0050"	=>	"Password for user that can list tree",
	"0051"	=>	"Use compatible mode (check this if you experienced problems, i.e. in Active Directory domain)",
